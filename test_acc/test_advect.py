...
o = IcebergDrift(loglevel=0, with_stokes_drift=True, wave_rad=True)
o.add_reader([reader_wind, reader_current, reader_wave])
...
o.run(
    ...
    outfile=os.path.join("test_openberg/test_acc/output", "test_advect_SD_Wave.nc"),
)
o.plot()
